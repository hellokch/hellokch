...
<h3>조건문 태그 : if , choose 태그 core tag else 없음</h3>
<c:if test= "${5 < 10 }">
<h4>5는 10보다 작다</h4>
</c:if>
<c:if test= "${6+3 != 10 }">
...
<c:choose>
 <c:when test="${5+10 == 25 }"><h4>5 + 10 = 25</h4></c:when>
 <c:when test="${5+10 == 15 }"><h4>5 + 10 = 25</h4></c:when>
 <c:when test="${5+10 == 510 }"><h4>5 + 10 = 510</h4></c:when>
