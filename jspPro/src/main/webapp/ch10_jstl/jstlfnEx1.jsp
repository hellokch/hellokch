...
<body>
	...
	<br> substringAfter(str1,3,6) = ${fn:substringAfter(str1,str2)}
	<br> substringBefore(str1,3,6) = ${fn:substringBefore(str1,str2)}
	<br> trim(str1) = [${fn:trim(str1)}]
	<br> replace(str1,"","-") = ${fn:replace(str1,"","-")}
	<br>
	<c:set var= "arr" value = "${fn:split(tokens,',') }" />
	<c:forEach var = "i" items="${arr}">
	${i } &nbsp;
	</c:forEach>
	<br> join(arr,'-') = ${fn:join(arr,'-')}
